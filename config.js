...
global.email = 'naeemkingt8@gmail.com' ;
global.location = 'Lahore Pakistan' ;
global.timezone  = process.env.TIME_ZONE || 'Asia/Karachi'
global.gurl = 'https://youtube.com/c/SuhailTechInfo' ; // add your username
global.sudo =  process.env.SUDO ? process.env.SUDO.replace(/[\s+]/g, '') : '923264700120'; ;
global.devs = "923264700120"; //Dont change it From here
...
module.exports = {
  ...
  botname: process.env.BOT_NAME || 'NAEEM KING',
  botbgm: process.env.BOT_BGM || 'true',
  ownername:  process.env.OWNER_NAME || `It'x NAEEM KING`,
  ...
  caption :process.env.CAPTION || "```ᴘᴏᴡᴇʀᴇᴅ ʙʏ NAEEMKING-ᴍᴅ```",   //*『NAEEM KING』*\n youtube.com"),
  OPENAI_API_KEY: process.env.OPENAI_API_KEY ||'' ,
  VERSION: process.env.VERSION || 'v.1.2.2',
  LANG: process.env.THEME ? process.env.THEME.toUpperCase() : 'NAEEM',
